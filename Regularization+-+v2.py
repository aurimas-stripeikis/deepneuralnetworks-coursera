...
def forward_propagation_with_dropout(X, parameters, keep_prob = 0.5):
    ...
    #if D1>keep_prob:
    #        D1 = 0
    #else: D1=1# Step 2: convert entries of D1 to 0 or 1 (using keep_prob as the threshold)
    ...
    #if D2>keep_prob:
    #        D2 = 0
    #else: D2=1                                         # Step 2: convert entries of D2 to 0 or 1 (using keep_prob as the threshold)
